...
const UpdateCc = () => {
  ...
  const validate = () => {
    ...
    cCertificates.forEach((certificate) => {
      const fieldErrors = [];
      ...
      if (!certificate.startDate.trim() || certificate.startDate === "day-Month-Year") {
        fieldErrors.push("Valid Start Date is required.");
        isValid = false;
      }
      if (!certificate.endDate.trim() || certificate.endDate === "day-Month-Year") {
        fieldErrors.push("Valid End Date is required.");
        isValid = false;
      }
